...
export const Toast: React.FC<ToastProps> = ({
  ...
  return (
    ...
    >
      <div className={`flex items-center p-4 rounded-lg shadow-lg text-white ${bgColorMap[type]}`}>
        ...
        <button 
          ...
          className="ml-4 text-white hover:text-gray-200 focus:outline-none rtl:ml-0 rtl:mr-4"
        >
